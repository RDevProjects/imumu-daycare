...
@section('content')
    ...
    <section class="relative overflow-hidden"
        style="background: linear-gradient(135deg, #ffd900 0%, #fff4a8 50%, #fff8e8 100%)">
            ...
            <div class="mt-12 md:mt-0 md:w-1/2 flex justify-center">
                <div class="relative">
                    <div class="rounded-card bg-white p-8 w-80"
                        style="box-shadow: 8px 8px 0 #09b1ab, 0 12px 30px rgba(47,43,43,0.12)">
                    ...
                    <div class="absolute -top-5 -right-5 flex h-16 w-16 items-center justify-center rounded-full font-display font-black text-xs text-center text-white rotate-12"
                        style="background:#e83f7d; box-shadow: 3px 3px 0 rgba(47,43,43,0.2)">ISLAMI ✨</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-decorated bg-dot-pattern"
        style="--dot-color: rgba(9,177,171,0.07); --dot-size: 20px; --deco-opacity: 0.12">
        <!-- Floating decorative shapes -->
        <div class="deco-shape deco-circle"
            style="--deco-color: #e83f7d; --deco-rotate: 15deg; width: 80px; height: 80px; top: 10%; right: 5%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-blob animate-deco-float"
            style="--deco-color: #09b1ab; --deco-rotate: -8deg; --deco-duration: 7s; width: 60px; height: 70px; bottom: 15%; left: 3%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-star animate-deco-float"
            style="--deco-color: #ffd900; --deco-rotate: 20deg; --deco-duration: 5s; --deco-delay: 1s; width: 40px; height: 40px; top: 30%; left: 8%;"
            aria-hidden="true"></div>
        ...
        <div class="relative mx-auto max-w-7xl px-4 py-16 md:py-24 md:px-8">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div class="rounded-card overflow-hidden border-2"
                    style="border-color:#e83f7d; box-shadow: 6px 6px 0 #ffd6e5">
                ...
                <div class="rounded-card overflow-hidden border-2"
                    style="border-color:#f36b21; box-shadow: 6px 6px 0 #ffe0c7">
    ...
    <div class="wavy-divider" aria-hidden="true">
        <svg viewBox="0 0 1440 60" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
            ...
            <path d="M0 30C240 60 480 0 720 30C960 60 1200 0 1440 30" stroke="#e83f7d" stroke-opacity="0.15"
                stroke-width="2" />
        </svg>
    </div>
    ...
    <div class="wavy-divider" aria-hidden="true">
        <svg viewBox="0 0 1440 60" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
            ...
            <path d="M0 30C180 0 360 60 540 30C720 0 900 60 1080 30C1260 0 1380 45 1440 30" stroke="#09b1ab"
                stroke-opacity="0.12" stroke-width="2" />
        </svg>
    </div>

    <!-- ===== KENAPA PILIH IMUMU ===== -->
    <section class="section-decorated bg-dot-pattern px-4 py-16 md:py-24 relative overflow-hidden"
        style="--dot-color: rgba(232,63,125,0.06); --dot-size: 22px; --deco-opacity: 0.12; background-color: #eaf9fc">
        <!-- Floating decorative shapes -->
        <div class="deco-shape deco-circle"
            style="--deco-color: #b85bd6; --deco-rotate: -5deg; width: 90px; height: 90px; top: 5%; right: 8%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-blob animate-deco-float"
            style="--deco-color: #f36b21; --deco-rotate: 18deg; --deco-duration: 6s; width: 55px; height: 65px; bottom: 12%; left: 5%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-star animate-deco-float"
            style="--deco-color: #09b1ab; --deco-rotate: -15deg; --deco-duration: 5.5s; --deco-delay: 1.5s; width: 38px; height: 38px; top: 40%; left: 12%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-diamond animate-deco-float"
            style="--deco-color: #ffd900; --deco-rotate: 40deg; --deco-duration: 8s; --deco-delay: 3s; width: 20px; height: 20px; bottom: 25%; right: 15%;"
            aria-hidden="true"></div>
    ...
    <section class="section-decorated px-4 py-16 md:py-24 relative overflow-hidden" style="--deco-opacity: 0.15">
        <!-- Floating decorative shapes -->
        <div class="deco-shape deco-circle animate-deco-float"
            style="--deco-color: #ffd900; --deco-rotate: 20deg; --deco-duration: 6s; width: 60px; height: 60px; top: 5%; left: 6%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-star animate-deco-float"
            style="--deco-color: #e83f7d; --deco-rotate: -10deg; --deco-duration: 5s; --deco-delay: 1s; width: 45px; height: 45px; top: 15%; right: 8%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-blob animate-deco-float"
            style="--deco-color: #09b1ab; --deco-rotate: 15deg; --deco-duration: 7s; --deco-delay: 2s; width: 50px; height: 60px; bottom: 8%; right: 12%;"
            aria-hidden="true"></div>
        <div class="deco-shape deco-diamond animate-deco-float"
            style="--deco-color: #b85bd6; --deco-rotate: 35deg; --deco-duration: 6.5s; --deco-delay: 0.5s; width: 22px; height: 22px; bottom: 18%; left: 10%;"
            aria-hidden="true"></div>

        <div class="relative mx-auto max-w-3xl rounded-card text-center px-8 py-12 md:px-16"
            ...
            <div class="mt-6 flex flex-wrap justify-center gap-4">
                ...
                <a href="{{ route('daftar') }}" class="btn btn-ghost btn-lg"
                    style="color:white; box-shadow: inset 0 0 0 2px white, 4px 4px 0 rgba(47,43,43,0.2)">Isi Formulir
                    Daftar</a>
            </div>
        </div>
    </section>
