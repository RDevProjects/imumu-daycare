...
@section('content')
    ...
    <!-- Page Hero -->
    <section class="px-4 py-16 md:py-20" style="background:#fff8e8">
    ...
    <section class="mx-auto max-w-7xl px-4 py-16 md:py-20 md:px-8">
        ...
        <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div class="card" style="border-color:#e83f7d">
    ...
    <section class="px-4 py-16 md:py-20" style="background:#eaf9fc">
        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div class="card" style="border-color:#f36b21">
                    <div class="text-4xl mb-3">🛏️</div>
    ...
    <section class="px-4 py-16 md:py-20">
        ...
        <div class="mx-auto max-w-3xl rounded-card text-center px-8 py-12"
