    ...
    <div class="max-w-3xl mx-auto space-y-6">
                ...
                <div class="w-14 h-14 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center">
                    <svg class="w-7 h-7 text-green-600 dark:text-green-400" fill="none" stroke="currentColor"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 17v-2m3 2l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                </div>
                <div>
        ...
        <div class="card">
            ...
            <form action="{{ route('dashboard.reports.finance.export') }}" method="GET" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1">Metode
                            Bayar</label>
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-2 gap-3">
                <a href="{{ route('dashboard.reports.finance.export', ['month' => date('n'), 'year' => date('Y'), 'format' => 'xlsx']) }}"
                    class="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-xl hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors no-underline">
                ...
                <a href="{{ route('dashboard.reports.finance.export', ['year' => date('Y'), 'format' => 'xlsx']) }}"
                    class="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors no-underline">
                ...
                <a href="{{ route('dashboard.reports.finance.export', ['status' => 'paid', 'format' => 'xlsx']) }}"
                    class="flex items-center gap-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors no-underline">
                ...
                <a href="{{ route('dashboard.reports.finance.export', ['status' => 'pending', 'format' => 'xlsx']) }}"
                    class="flex items-center gap-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition-colors no-underline">
