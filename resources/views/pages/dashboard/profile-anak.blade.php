...
@php
  ...
  $headerActions = '<button @click="$dispatch(\'open-add-child-modal\')" class="btn-primary text-sm py-2 px-5">Tambah Anak</button>';
@endphp

{{-- ===== DATA ===== --}}
@php
$children = [
    ['name' => 'Aisyah Putri', 'age' => 3, 'kelas' => 'bunga', 'color' => 'pink', 'parent' => 'Ibu Sari', 'status' => 'aktif'],
    ['name' => 'Raka Pratama', 'age' => 4, 'kelas' => 'matahari', 'color' => 'blue', 'parent' => 'Bapak Ahmad', 'status' => 'aktif'],
    ['name' => 'Nadia Safitri', 'age' => 2, 'kelas' => 'bintang', 'color' => 'yellow', 'parent' => 'Ibu Dewi', 'status' => 'aktif'],
    ['name' => 'Dimas Aditya', 'age' => 5, 'kelas' => 'bulan', 'color' => 'green', 'parent' => 'Ibu Rina', 'status' => 'cuti'],
    ['name' => 'Zahra Aulia', 'age' => 3, 'kelas' => 'bunga', 'color' => 'purple', 'parent' => 'Bapak Budi', 'status' => 'aktif'],
    ['name' => 'Farhan Rizki', 'age' => 4, 'kelas' => 'matahari', 'color' => 'teal', 'parent' => 'Ibu Mega', 'status' => 'sakit'],
    ['name' => 'Cantika Dewi', 'age' => 2, 'kelas' => 'bintang', 'color' => 'rose', 'parent' => 'Bapak Eko', 'status' => 'aktif'],
    ['name' => 'Aldi Firmansyah', 'age' => 5, 'kelas' => 'bulan', 'color' => 'indigo', 'parent' => 'Ibu Wati', 'status' => 'pindah'],
];
...
$colorMap = [
    'pink' => 'bg-pink-500', 'blue' => 'bg-blue-500', 'yellow' => 'bg-yellow-500', 'green' => 'bg-green-500',
    'purple' => 'bg-purple-500', 'teal' => 'bg-teal-500', 'rose' => 'bg-rose-500', 'indigo' => 'bg-indigo-500',
];
@endphp
...
<div x-data="{ searchQuery: '', filterKelas: 'semua', showAddModal: false }" @open-add-child-modal.window="showAddModal = true">
      ...
      <div class="card overflow-hidden group hover:-translate-y-2 transition-all duration-300">
        ...
        <div class="space-y-3">
          <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>Kelas: </span>
            <span class="font-semibold text-gray-700 dark:text-imumu-dark-text capitalize">Kelas {{ $child['kelas'] }}</span>
          </div>
          <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span>Orang Tua: </span>
            <span class="font-semibold text-gray-700 dark:text-imumu-dark-text">{{ $child['parent'] }}</span>
          </div>

          {{-- Action Buttons --}}
          <div class="flex gap-2 pt-3 border-t border-gray-100 dark:border-imumu-dark-border">
            <button class="flex-1 py-2 text-sm font-semibold text-imumu-pink-dark bg-imumu-pink-light rounded-lg hover:bg-imumu-pink transition-colors cursor-pointer">Edit</button>
            <button class="flex-1 py-2 text-sm font-semibold text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors cursor-pointer">Detail</button>
          </div>
        </div>
      </div>
    @endforeach
  ...
  {{-- ===== MODAL: Tambah Anak ===== --}}
  <div x-show="showAddModal" x-transition.opacity class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div x-show="showAddModal"
      ...
      <div class="p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="block text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1">Usia (tahun)</label>
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1">No. Telepon Orang Tua</label>
          <input type="tel" placeholder="08xxxxxxxxxx" class="input-field">
        </div>
        <div>
          <label class="block text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1">Alergi / Catatan Khusus</label>
