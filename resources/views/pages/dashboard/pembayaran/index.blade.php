    ...
    <div class="space-y-6">
            ...
            <div class="stat-card border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-700 dark:text-imumu-dark-text mt-1">Rp
        ...
        <div class="bg-white dark:bg-imumu-dark-card rounded-xl shadow-sm p-4">
            <form method="GET" class="flex flex-wrap gap-3">
                ...
                <a href="{{ route('dashboard.reports.finance') }}" class="btn-success px-4 flex items-center gap-2">📥
                    Export Excel</a>
            </form>
        </div>
                            ...
                            <td class="py-3 px-4">
                                <div class="flex gap-2 flex-wrap">
                                    @if ($payment->status === 'pending')
                                        <a href="{{ route('dashboard.pembayaran.verify', $payment) }}"
                                            class="px-3 py-1.5 bg-blue-500 text-white text-xs font-semibold rounded-lg hover:bg-blue-600 no-underline">
                                            Verifikasi
                                        </a>
                                        <form action="{{ route('dashboard.pembayaran.mark-cash', $payment) }}"
                                            method="POST">
                                            @csrf
                                            <button type="submit"
