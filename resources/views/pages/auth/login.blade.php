...
@section('content')
    <div class="flex items-center justify-center min-h-screen px-4 relative z-10">
        <div
            class="bg-white dark:bg-imumu-dark-card dark:border-imumu-dark-border rounded-2xl shadow-lg p-8 w-full max-w-md border border-gray-100 dark:border-imumu-dark-border fade-in">
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="admin@imumu.com"
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="show = !show"
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-400 hover:text-imumu-pink-dark transition-colors">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember"
                            class="w-4 h-4 text-imumu-pink-dark rounded border-gray-300 focus:ring-imumu-pink-dark">
                        <span class="text-sm text-gray-500 dark:text-gray-400">Ingat saya</span>
                    </label>
                    <a href="#"
                        class="text-sm text-imumu-pink-dark dark:text-imumu-dark-pink font-semibold hover:underline">Lupa
                        password?</a>
                </div>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('home') }}"
                    class="text-sm text-gray-400 dark:text-gray-400 hover:text-imumu-pink-dark dark:hover:text-imumu-dark-pink transition-colors">←
